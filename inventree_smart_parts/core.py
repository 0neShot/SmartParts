...
class SmartPartsPlugin(UserInterfaceMixin, SettingsMixin, UrlsMixin, InvenTreePlugin):
    ...
    def setup_urls(self):
        ...
        return [
            ...
            path('api/test-connection/<str:provider>/', views.test_connection, name='test-connection'),
            ...
            # Stock & Label APIs
            path('api/stock/locations/', views.api_stock_locations, name='api-stock-locations'),
            path('api/label/templates/', views.api_label_templates, name='api-label-templates'),
            ...
            path('purescan/commands/', views.purescan_command_sheet, name='purescan-commands'),
            path('api/purescan/resolve/', views.purescan_resolve_barcode, name='purescan-resolve'),
            path('api/purescan/print/', views.purescan_print_label, name='purescan-print'),
        ]
